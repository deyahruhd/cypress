 ...
 * | Shift     |    Z      |   X  |   C  |   V  |   B  |     |   N  |   M  |   ,  |   .  |   /  |  '   |
 * |-----------+-----------+------+------+------+------|     |------+------+------+------+------+------|
 * | PlayMacro1|Play Macro2| Ctrl | Alt  |Lower |Space |     | Space|Raise | Left | Down |  Up  |Right |
 * `---------------------------------------------------'     `-----------------------------------------'
 */
...
[_LOWER] = LAYOUT_ortho_4x12( \
  ...
  _______, _______, _______, _______, _______, _______,                /**/                KC_HASH, KC_ASTR, _______, _______, _______, _______, \
...
/* Adjust (Lower + Raise)
 * ,-----------------------------------------.     ,-----------------------------------------.
 * | Reset|      |  F1  |  F2  |  F3  |  F4  |     |   !  |   @  |   &  |   (  |   )  | Bksp |
 * |------+------+------+------+------+------|     |------+------+------+------+------+------|
 * | Del  |      |  F5  |  F6  |  F7  |  F8  |     |   +  |   =  |   -  |   {  |   }  |Enter |
 * |------+------+------+------+------+------|     |------+------+------+------+------+------|
 * | Blite|      |  F9  | F10  | F11  | F12  |     |   #  |   *  |      |      |      |      |
 * |------+------+------+------+------+------|     |------+------+------+------+------+------|
 * |      |      |      |      |      |      |     |      |      |      |      |      |      |
 * `-----------------------------------------'     `-----------------------------------------'
 */
[_ADJUST] =  LAYOUT_ortho_4x12( \
  ...
  BL_STEP, _______, KC_F9,   KC_F10,  KC_F11,  KC_F12,                 /**/                KC_HASH, KC_ASTR, _______,  _______, _______, _______, \
  _______, _______, _______, _______, _______, _______,                /**/                _______, _______, _______,  _______, _______, _______  \
),
